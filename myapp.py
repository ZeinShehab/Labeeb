    ...
    while True and index < len(images):
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                flip_hands = ["Left", "Right"]
                handedness.classification[0].index = int(not handedness.classification[0].index)
                handedness.classification[0].label = flip_hands[handedness.classification[0].index]
                ...
                debug_image = draw_info_text(
                    ...
                    keypoint_classifier_labels[number],
                )
                index += 1
                iterations = 0

        # debug_image = draw_point_history(debug_image, point_history)
        debug_image = draw_info(debug_image, fps, 0, number)
